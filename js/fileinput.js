...
(function ($) {
    ...
    var DEFAULT_PREVIEW = '<div class="file-preview-other" ' + STYLE_SETTING + '>\n' +
        '       <h2><img src="/APPELECTRONORTE/public/img/excel.png" alt="Excel"></h2>\n' +
        '   </div>';
    ...
    $.fn.fileinput.defaults = {
        ...
        msgInvalidFileExtension: 'Extensión no válido para archivo "{name}". Sólo se admiten archivos "{extensions}"',
        msgValidationError: '<span class="text-danger"><i class="glyphicon glyphicon-exclamation-sign"></i>Error al Cargar Archivo</span>',
        msgErrorClass: 'file-error-message',
        msgLoading: 'Carga de Archivos {index} de {files} &hellip;',
        msgProgress: 'Carga de Archivos {index} de {files} - {name} - {percent}% completed.',
